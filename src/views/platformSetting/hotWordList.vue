    ...
    <div class="table-head clearfix">
      ...
      <div class="sch">
        <el-form :inline="true" :model="formInline" class="table-form-inline">
          <el-form-item label="">
            <el-input v-model="formInline.name" placeholder="请输入热词" @keyup.enter.native="getList"></el-input>
          </el-form-item>
          <el-form-item>
  ...
  methods: {
    ...
    deleteItem(scope) {
      this.$confirm('确定删除 ' + scope.name, '提示', {
        ...
        this.$http({
          url: '/goodsmanage/backadmin/hotWord/' + scope.id,
          method: 'DELETE',
        })
          .then(res => {
    ...
    editItem(scope) {
      this.$router.push({path: '/hotWordEdit', query: {id: scope.id}})
    },
    newItem() {
      this.$router.push({path: '/hotWordEdit'})
    },
  }
}
</script>
